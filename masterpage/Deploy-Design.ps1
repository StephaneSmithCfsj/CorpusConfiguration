...
try
{
    ...
    Add-SPOMasterPage -SourceFilePath "$PSScriptRoot/app/fsj.master" -Title "MDD Fort Saint Jean MasterPage" -Description "MasterPage for FSJ Intranet WITH MDD" -DestinationFolderHierarchy "FSJ"
    ...
    set-spomasterpage -MasterPageSiteRelativeUrl _catalogs/masterpage/FSJ/CFSJ-mdd-responsive.master
